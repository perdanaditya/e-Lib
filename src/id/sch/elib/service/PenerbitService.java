 ...
 * @author rizky.aditya
 */
public class PenerbitService implements BaseServiceInterface {

    private final GrailsRestClient grc = new GrailsRestClient();
    private final Gson gson = new Gson();
    private final String endpoint = "penerbit";
    
    @Override
    public Object listAll() {
        String json = grc.get(endpoint);
        Type type = new TypeToken<List<Penerbit>>() {
        }.getType();
        List<Penerbit> output = gson.fromJson(json, type);
        return output;
    }

    @Override
    public Object get(long id) {
        Penerbit jo = gson.fromJson(grc.get(endpoint + "/" + id), Penerbit.class);
        return jo;
    }
    ...
    public Object search(Object obj) {
        ...
        ArrayList<Penerbit> list = gson.fromJson(response, type);
        return list;
    }

 ...
 * @author rizky.aditya
 */
public class PengarangService implements BaseServiceInterface{
    
    private final GrailsRestClient grc = new GrailsRestClient();
    private final Gson gson = new Gson();
    private final String endpoint = "pengarang";

    @Override
    public Object listAll() {
        String json = grc.get(endpoint);
        Type type = new TypeToken<List<Pengarang>>() {
        }.getType();
        List<Pengarang> output = gson.fromJson(json, type);
        return output;
    }

    @Override
    public Object get(long id) {
        Pengarang jo = gson.fromJson(grc.get(endpoint + "/" + id), Pengarang.class);
        return jo;
    }
    ...
    public Object search(Object obj) {
        ...
        ArrayList<Pengarang> list = gson.fromJson(response, type);
        return list;
    }

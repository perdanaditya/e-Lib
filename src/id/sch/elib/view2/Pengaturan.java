...
public class Pengaturan extends javax.swing.JFrame {
    ...
    public Pengaturan() {
        ...
        Pengaturan.this.setExtendedState(Pengaturan.this.getExtendedState() | JFrame.MAXIMIZED_BOTH);
    }
    ...
    private void initComponents() {
        ...
        backRole = new javax.swing.JButton();
        ...
        backRole.setText("Back to Main Menu");
        backRole.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                backRoleActionPerformed(evt);
            }
        });
        ...
        backDenda.setText("Back to Main Menu");
    ...
    private void backRoleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backRoleActionPerformed
        // TODO add your handling code here:
        backToMainMenu();
    }//GEN-LAST:event_backRoleActionPerformed
...
//    }
    ...
    private javax.swing.JButton backRole;

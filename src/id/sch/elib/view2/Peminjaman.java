...
public class Peminjaman extends javax.swing.JFrame {
    ...
    private ArrayList<id.sch.elib.model.Peminjaman> masterPeminjamanList;
    private ArrayList<id.sch.elib.model.Peminjaman> peminjamanList;
    ...
    private JComboBox<String> cmbKembali;

    private boolean editMode;
    private id.sch.elib.model.Peminjaman peminjamanModel;
    private Buku b;
    private User user;
    ...
    public Peminjaman() {
        ...
        columnDetailName = new ArrayList<>();
        ...
        Peminjaman.this.setExtendedState(Peminjaman.this.getExtendedState() | JFrame.MAXIMIZED_BOTH);
    }

    public void reInitValiables() {
        detailPeminjamanList = new ArrayList<>();
        peminjamanModel = new id.sch.elib.model.Peminjaman();
        user = new User();
        b = new Buku();
        editMode = false;
    ...
    private id.sch.elib.model.Peminjaman getPeminjamanById(long id) {
        for (int i = 0; i < peminjamanList.size(); i++) {
            id.sch.elib.model.Peminjaman p = peminjamanList.get(i);
            if (p.getId() == id) {
                return p;
            }
        }
    ...
    private void initComponents() {
        ...
        setTitle("Library Manager SMA Negeri 1 Baleendah - Alpha Version 1.1");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Input Data Peminjaman"));
